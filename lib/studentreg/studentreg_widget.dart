...
import '/components/regsuccess_widget.dart';
...
import 'studentreg_model.dart';
export 'studentreg_model.dart';

class StudentregWidget extends StatefulWidget {
  const StudentregWidget({super.key});

  static String routeName = 'studentreg';
  static String routePath = 'studentreg';

  @override
  State<StudentregWidget> createState() => _StudentregWidgetState();
}

class _StudentregWidgetState extends State<StudentregWidget> {
  late StudentregModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentregModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'studentreg'});
                  ...
                  child: ConstrainedBox(
                    constraints: BoxConstraints(
                      minHeight: MediaQuery.of(context)
                          .size
                          .height, // Ensures vertical centering
                    ),
                    child: Column(
                        ...
                        Align(
                          ...
                          child: Builder(
                            builder: (context) => InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'STUDENTREG_Container_8t7mgfad_ON_TAP');
                                logFirebaseEvent('Container_validate_form');
                                _model.errormess = true;

                                if (_model.formKey.currentState == null ||
                                    !_model.formKey.currentState!.validate()) {
                                  safeSetState(() => _model.errormess = false);
                                  return;
                                }

                                if (_model.roleValue == null) {
                                  await actions.dropDown();
                                  _model.errormess = false;
                                  safeSetState(() {});
                                  return;
                                }
                                ...
                                _model.result = await actions.checkInternet();
                                ...
                                if (_model.result == true) {
                                  ...
                                  try {
                                    ...
                                    _model.apiResulthzm =
                                      ...
                                      passwordConfirmation:
                                          _model.yourNameTextController5.text,
                                      university: _model.stateValue,
                                  ...
                                  if ((_model.apiResulthzm?.succeeded ??
                                      true)) {
