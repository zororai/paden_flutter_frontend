            ...
            Builder(
              builder: (context) => Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'HOME_PAGE_PAGE_Container_757wy1pp_ON_TAP');
              ...
              child: Container(
                ...
                child: FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewHomestatusResponse = snapshot.data!;

                    return Builder(
                      builder: (context) {
                        final home =
                            listViewHomestatusResponse.jsonBody.toList();
                          ...
                          itemBuilder: (context, homeIndex) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOME_PAGE_PAGE_Container_i4036nwb_ON_TAP');
                                  logFirebaseEvent(
                                  ...
                                  _model.geo =
                                      await actions.parseLatLngFromString(
                                    getJsonField(
                                      homeItem,
                                      r'''$.geo''',
                                    ).toString(),
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_PAGE_Column_qt2c4fm0_ON_TAP');
                                      logFirebaseEvent(
              ...
              child: Container(
                ...
                child: FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Builder(
                      builder: (context) {
                        final pop = listViewPopularResponse.jsonBody.toList();

                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          scrollDirection: Axis.horizontal,
                          itemCount: pop.length,
                          itemBuilder: (context, popIndex) {
                            final popItem = pop[popIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 10.0, 15.0, 0.0),
                              child: Row(
