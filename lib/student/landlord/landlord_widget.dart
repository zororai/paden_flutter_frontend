...
class LandlordWidget extends StatefulWidget {
  ...
  static String routeName = 'landlord';
  static String routePath = 'landlord';
...
class _LandlordWidgetState extends State<LandlordWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LandlordModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'landlord'});
  }
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'LANDLORD_PAGE_Icon_fw44em21_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Icon_navigate_to');
