...
class _AllowNotificationPopupWidgetState
    extends State<AllowNotificationPopupWidget> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: Container(
          width: MediaQuery.sizeOf(context).width * 1.014,
          height: 317.01,
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'ALLOW_NOTIFICATION_POPUP_Container_t1n2p');
