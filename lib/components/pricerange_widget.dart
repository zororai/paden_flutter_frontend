...
import 'pricerange_model.dart';
export 'pricerange_model.dart';
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Enter price range and location',
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'PRICERANGE_Container_i8rgcy2f_ON_TAP');
                            ...
                            _model.apiResultkq7 = await SearchCall.call(
                              min: _model.textController3.text,
                              max: _model.textController2.text,
                              location: _model.textController1.text,
                              token: currentAuthenticationToken,
                            );

                            if ((_model.apiResultkq7?.succeeded ?? true)) {
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content: Text('Search results not found'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
