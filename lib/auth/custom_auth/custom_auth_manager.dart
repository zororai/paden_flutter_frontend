...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    padenAuthUserSubject.add(
      PadenAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PadenAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PadenAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PadenAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    padenAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
