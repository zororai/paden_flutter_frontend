...
import 'login22_model.dart';
export 'login22_model.dart';

class Login22Widget extends StatefulWidget {
  const Login22Widget({super.key});

  static String routeName = 'login22';
  static String routePath = 'login22';

  @override
  State<Login22Widget> createState() => _Login22WidgetState();
}

class _Login22WidgetState extends State<Login22Widget> {
  late Login22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Login22Model());
